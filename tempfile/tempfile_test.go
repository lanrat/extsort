...
func TestSingleTempFile(t *testing.T) {
	...
	tempWriter, err := tempfile.New("", true)
	if err != nil {
		t.Fatal(err)
	}
...
// TestMockFileImplementation tests the in-memory mock implementation
func TestMockFileImplementation(t *testing.T) {
	line := "The quick brown fox jumps over the lazy dog"
...
func TestMockFileMultiSection(t *testing.T) {
	iterations := 10
	line := "The quick brown fox jumps over the lazy dog"
